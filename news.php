...
<div class="gridContainer clearfix">
  <div id="LayoutDiv1"><!-- InstanceBeginEditable name="EditRegion3" -->
    ...
    <div id="btn_n"><a href="news.php"><img src="image/bn_n.png" width="46" height="100"></a></div>
    ...
    <div class="bg">
      <div class="content_new1">
        <table width="200" border="0">
          <tr>
            <td><a href="#n1">活動一</a></td>
          </tr>
          <tr>
            <td><a href="#n2">活動二</a></td>
          </tr>
          <tr>
            <td><a href="#n3">活動三</a></td>
          </tr>
        </table>
      </div>
      <div class="content_new2">
       	<div class="new2_0">
       	  <p><img src="image/new0.png"></p>
       	</div>
       	
        <div class="new2_1">
        <a id="n1"></a>
        這是版面 Div 標籤「new2_1」的內容</div>
        <div class="new2_2">
          <a id="n2"></a>
        插入>版面物件>DIV標籤 </div>
        <div class="new2_3">
          <a id="n3"></a>
        這是版面 Div 標籤「new2_3」的內容
        </div>
      </div>
    </div>
