...
<div class="gridContainer clearfix">
  <div id="LayoutDiv1"><!-- InstanceBeginEditable name="EditRegion3" -->
    ...
    <div id="btn_r"><a href="rooms.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image2','','image/room_.png',1)"><img src="image/bn_r.png" width="46" height="100"></a></div>
    ...
    ></div>
    <div id="btn_b"><a href="board.php"><img id="Image7" src="image/board.png" width="48" height="72"></a></a></div>
    <div id="btn_s">
	<?php
...
if($_SESSION["SB"]==0 && $_SESSION["SQ"]==0 && $_SESSION["CQ"]==0){
	echo "<script>alert('您無權觀看此畫面!');</script>";
	echo '<meta http-equiv="REFRESH" CONTENT=1;url=room.php>';
	}
else {
	$ordername=$_SESSION["ordername"];
	$chickin=$_SESSION["chickin"];
	$day=$_SESSION["day"];
	$sb=$_SESSION["sb"];
	$sq=$_SESSION["sq"];
	$cq=$_SESSION["cq"];
	$nowtime=$_SESSION["nowtime"];
	echo "訂房者：".$ordername."<br>住房日期：".$chickin."<br>住房天數：".$day."<br>房型：<br>     木屋二人房：".$sb."間<br>     舒適二人房：".$sq."間<br>     樓中樓小木屋六人房：".$cq."間<br><br>確認無誤，按下確認後送出訂單<br>";
}
?>

<?php
if(isset($_REQUEST["submit"])){
	$sql = "insert into order (memberid, name, checkin, day, sb, sq, cq, nowtime) values ('$id', '$ordername', '$chickin', '$day', '$sb', '$sq', '$cq', '$nowtime')";
		  if(mysql_query($sql)){
